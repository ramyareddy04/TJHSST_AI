...
def part2():
    ...
    for i in range(2**(2**n)):
        ...
        b = 0
        w, b = stabilize(i, w, b)
        if check(i, w, b) == 1: total += 1
    print(str(2**(2**n)),'possible functions;',str(total),'can be correctly modeled.')
...
b = 0
w, b = stabilize(i, w, b)
# print(pretty_print_tt(truth_table(len(w), i)))
print("Weight:",w,"\t\tBias:",b,"\tAccuracy:", check(i, w, b))